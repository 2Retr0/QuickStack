...
void main(){
//    fragColor = texture(DiffuseSampler, texCoord) * vec4(1.2, 0.7, 0.2, 1.0);
...
//    vec3 outColor = center.rgb * center.a + left.rgb * left.a + right.rgb * right.a + up.rgb * up.a + down.rgb * down.a;
    ...
    vec3 teal = vec3(0.0, 0.667, 0.667);
    vec3 outColor = teal.rgb * center.a + teal.rgb * left.a + teal.rgb * right.a + teal.rgb * up.a + teal.rgb * down.a;
